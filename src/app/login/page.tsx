  ...
  return (
    ...
    >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {successMessage && (
                  <div
                    ...
                    className="text-sm text-green-600 bg-green-50 p-3 rounded-md flex items-center"
                  >
                    <div
                      id="page-div-11"
      ...
      <div
        ...
        className="hidden lg:flex flex-1 bg-blue-50 dark:bg-blue-950/20 items-center justify-center p-8"
      >
        <div
          id="page-div-16"
