...
export default function ContentManagerPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Changed to 5 columns on large screens to fit all 5 cards without wrapping */}
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              <div className="p-3 bg-gray-100 rounded-lg">
                {/* Consider swapping Edit for FileText or similar if Edit doesn't feel right for Archive */}
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              <div className="p-3 bg-red-100 rounded-lg">
                {/* Changed from CheckCircle to XCircle for visually distinct Rejected status */}
