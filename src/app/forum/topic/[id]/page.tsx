...
export default function ForumTopicPage({ params }: PageProps) {
  ...
  // Assuming a hook that provides edit/delete mutations similar to usePostByIdQuery
  // const {
  //   mutate: forumEditComment,
  //   mutate: forumDeleteComment,
  //   mutate: forumEditReply,
  //   mutate: forumDeleteReply,
  //   mutate: forumEditReplyToReply,
  //   mutate: forumDeleteReplyToReply,
  // } = useForumEditDeleteMutations(token, id); // Placeholder hook name; adjust as needed
  ...
  const handleSaveEditComment = async (commentId: string) => {
    if (editCommentContent.trim()) {
      try {
        // forumEditComment({ content: editCommentContent, commentId });
  ...
  const handleSaveEditNestedReply = async (
    ...
    if (editNestedReplyContent.trim()) {
      try {
        // forumEditReplyToReply({
        //   content: editNestedReplyContent,
        //   commentId,
        //   replyId,
