    ...
    <div id="user-publication-div-1" data-testId="user-publication-div-1" key={pub?.pubId}>
      <div id="user-publication-flex-2" data-testId="user-publication-flex-2" className="flex items-start space-x-4">
        ...
        <div id="user-publication-div-4" data-testId="user-publication-div-4" className="flex-1 min-w-0">
          <p className="text-sm">
            This user <span id="user-publication-span-1" data-testId="user-publication-span-1" className="font-medium">published</span>{" "}
            <span id="user-publication-span-2" data-testId="user-publication-span-2" className="font-medium break-words">{pub?.title}</span>
          </p>
          <div id="user-publication-flex-5" data-testId="user-publication-flex-5" className="flex items-center gap-4 mt-1 text-xs text-muted-foreground">
            ...
            <span id="user-publication-span-3" data-testId="user-publication-span-3">{timeAgo(pub?.createdAt)}</span>
            <span id="user-publication-span-4" data-testId="user-publication-span-4">{pub?.pubComments?.length || 0} comments</span>
            <span id="user-publication-span-5" data-testId="user-publication-span-5">{pub?.pubLikes?.length || 0} likes</span>
          </div>
        </div>
