  ...
  return (
    <Card key={publication.pubId} className="hover:shadow-md transition-shadow">
      <CardContent className="p-4 sm:p-6">
        <div
          id="archived-div-1"
          data-testId="archived-div-1"
          className="space-y-3"
        >
          <div
            id="archived-flex-2"
            data-testId="archived-flex-2"
            className="flex items-start justify-between gap-2"
          >
            <div
              id="archived-div-3"
              data-testId="archived-div-3"
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  id="archived-button-1"
                  data-testId="archived-button-1"
                  variant="ghost"
                  size="icon"
                  className="shrink-0"
                >
